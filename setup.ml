...
(* OASIS_START *)
(* DO NOT EDIT (digest: ce76bcd286b0af35e717536331c2b450) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$mcl_tests", []))];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "mclc.ml"});
               Executable
                 ({
                     cs_name = "mcl_tests";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "mcl_tests.ml"});
               Test
                 ({
                     cs_name = "unit_tests";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "mcl_tests"]
                   })
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Nn*/\132+\011\182\003\234Q\146\127P\157\146";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
